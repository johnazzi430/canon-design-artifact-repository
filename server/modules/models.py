...
class ProductSchema(ma.ModelSchema):
    personas = ma.Nested(
        "PersonaSchema", many=True, exclude=("products", "persona_picture", "cust_id")
    )
...
class Persona(db.Model):
    ...
    roles = db.relationship(
        "PersonaRoles", secondary="persona_roles_rel", backref=db.backref("personas")
    )
...
class Insight(db.Model):
    ...
    personas = relationship(
        "Persona", secondary="insight_persona_rel", backref=db.backref("insights")
    )
    products = relationship(
        "Product", secondary="insight_product_rel", backref=db.backref("insights")
    )
